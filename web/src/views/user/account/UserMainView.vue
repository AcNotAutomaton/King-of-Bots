...
export default{
    setup(){
        ...
        const get_user_info = () => {
            $.ajax({
                url: "http://47.120.10.114:3000/api/user/account/user/info/",
                type: "get",
                data:{
                    id: user_id.value
                },
        ...
        const refresh_bots = () => {
            $.ajax({
                url: "http://47.120.10.114:3000/api/user/bot/getlist/user/",
                type: "get",
                data:{
        ...
        const get_list = ()=>{
            $.ajax({
                url: "http://47.120.10.114:3000/api/record/getuesrlist/",
                data: {
                    id: user_id.value
                },
                type: "get",
